    ...
    <footer className="bg-[#060f14] border-t border-[#173040] mt-20">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Ummah Premier Futsal League - Ummah's premier indoor futsal competition.
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-400">
              ...
              <span className="flex items-center gap-2"><Mail size={14} className="text-yellow-400" /> info@upfl-cleveland.com</span>
        ...
        <div className="border-t border-[#173040] mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-2">
          <p className="text-gray-500 text-xs">Â© 2025 Ummah Premier Futsal League. All rights reserved.</p>
